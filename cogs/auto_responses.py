    ...
    async def on_message(self, message):
        ...
        if message.content.lower().replace("'", "").strip().startswith("i am"):
            responses = {
                ...
                "daydreamer":"You're not Daydreamer, I'm Daydreamer!",
        ...
        # hey daydreamer
        if message.content.lower().startswith("hey daydreamer"):
            greetings = [
                "Hello.", 
                "Hello there!", 
                "Hi.", 
            ...
            try:
                ...
                if reply_message.content.lower().startswith("you're") or reply_message.content.lower().startswith("youre") or reply_message.content.lower().startswith("ur"):
                    responses = {
                        ...
                        "a clever bot":"Thanks very much!",
                        "a cleverbot":"Haha I see what you did there.",
                        "a smart bot":"What if I'm not?"
                    }
                    for trigger, response in list(responses.items()):
